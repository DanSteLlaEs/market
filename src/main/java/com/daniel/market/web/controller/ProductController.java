...
import com.daniel.market.domain.service.ProductService;
...
public class ProductController {
  ...
  //  public List<Product> getAll(){
    ...
    @GetMapping("/{id}")
    @ApiOperation("Search a prodcut with an ID")
    @ApiResponses({
            @ApiResponse(code = 200,message = "OK"),
    ...
    public ResponseEntity<List<Product>> getByCategoy(@PathVariable("id") int categoryId){
